...
import { Refferals } from '../../../types/models/refferals';
import RefferalsService from '../../../service/RefferalsService';
...
const Refferals = () => {
    ...
    const [refferals, setRefferals] = useState<Refferals[]>([]);
    ...
    const dateBodyTemplate = (rowData: Refferals) => {
        return rowData.BeginDate ? formatDate(rowData.BeginDate) : "";
    };

    const retrieveDirectMember = () => {
        ...
        RefferalsService.get(currentPage, lazyState.rows, filterProcess, searchFromDateFormat, searchToDateFormat)
    ...
    const exportExcel = () => {
        ...
        RefferalsService.get(firstPage, Number.MAX_SAFE_INTEGER, filterProcess, searchFromDateFormat, searchToDateFormat)
            .then((response: DefaultResponse) => {
